...
const values = [
	{
		title: 'Async',
		desc: 'Working and communicating asynchronously to accommodate our international team.',
		icon: Clock
	},
	{
		title: 'Quality',
		desc: 'From our code implementation to program, we strive to build the best route possible.',
		icon: Star
	},
	{
		title: 'Speed',
		desc: 'We get things done quickly, through small iteration cycles and sprints, meeting frequently.',
		icon: LightningSlash
	},
	{
		title: 'Transparency',
		desc: 'Through overcoming challenges and admitting mistakes, we can move forward quickly.',
		icon: Heart
	}
];
...
const perks = [
	{
		...
		desc: `We want the best, and will pay for the best. We will make sure you're paid what you're worth.`,
		icon: CurrencyDollar,
		color: '#0DD153'
	},
	{
		title: 'Stock Options',
		desc: `As an early employee, you deserve to own a piece of the company. Stock options will be offered as part of the onboarding process.`,
		icon: TrendUp,
		color: '#BD0DD1'
	},
	{
		title: 'Paid Time Off',
		desc: `You deliver your best work when you've had your downtime. We offer 15 days paid time off per year with a 9/80 work schedule.`,
		icon: Smiley,
		color: '#9210FF'
	},
	{
		title: 'Work From Home',
		desc: `We're remote first and intend to keep it that way.`,
		icon: House,
		color: '#D1A20D'
	},
	{
		title: 'Desk Budget',
		desc: `Need an M1 MacBook Pro? We've got you covered with all software and licensure covered.`,
		icon: Desktop,
		color: '#0DC5D1'
	},
	{
		title: 'Health Care',
		desc: `We use Deel for hiring and payroll, so that your needs are covered.`,
		icon: Heart,
		color: '#D10D7F'
	}
];
...
export default function CareersPage() {
	...
	return (
		<PageWrapper>
			<Head>
				<title>Careers - EduX</title>
				<meta
					name="description"
					content="Work with us to build the future of degree scheduling."
				/>
			</Head>
			<div className="prose prose-invert container relative m-auto mb-20 min-h-screen max-w-4xl p-4 pt-32 text-white">
				...
				<h1 className="fade-in-heading mb-3 px-2 text-center text-4xl font-black leading-tight text-white md:text-5xl">
					Build the future of degree scheduling.
				</h1>
				<div className="animation-delay-1 z-30 flex flex-col items-center fade-in">
					<p className="z-40 text-center text-lg text-gray-350">
						EduX is redefining the way we handle degree scheduling, building a unified platform to help calculate your best academic route and make graduating easier.
					</p>
					<Button
					...
					<p className="mt-2">
						...
						<strong>careers at edux dot ai</strong> and we'll get back to you
						shortly!
					</p>
				</div>
			</div>
